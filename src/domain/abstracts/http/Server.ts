...
export abstract class Server implements IServer {
    ...
    public addController(...controllers: IController[]): void {
        controllers.forEach((controller) => {
            const methodNames = new Set<keyof typeof controller>();
            ...
            while (proto && proto !== Object.prototype) {
                Object.getOwnPropertyNames(proto)
                    ...
                    .forEach((method) => methodNames.add(method as keyof typeof controller));
            ...
            methodNames.forEach((methodName) => {
                ...
                if (!httpMethod || !routePath) return;
                ...
                const handler: IMethodHandler = controller[methodName]
                this.routes.push({
                    name: methodName,
                    path: `${this.options.path}${routePath}`,
                    method: httpMethod,
